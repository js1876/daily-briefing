      ...
      <div class="main-column">
        <header class="hero-card">
          <div class="hero-content">
            ...
            <p class="meta live-market-status" id="live-market-status" data-live-feed="https://js1876.github.io/daily-briefing/public/market-live.json" data-live-stream="https://drivers-ben-processor-moves.trycloudflare.com/api/v1/live-stream">실시간 체결 연결 준비 중</p>
