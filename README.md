...
매일 오전 9시 20분에 국내 반도체 포트폴리오 가격, 뉴스, 매크로 지표, 반도체 사이클 분석을 리서칭해 HTML 브리핑을 생성하고 GitHub Pages에 배포한 뒤, 오전 9시 30분 이후 디스코드 웹훅으로 링크를 전달합니다.
